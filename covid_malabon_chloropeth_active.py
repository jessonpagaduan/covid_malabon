# -*- coding: utf-8 -*-
"""
Created on Sat Jun  6 13:51:04 2020
...
ax.set_title('Active Cases in Malabon City (as of June 9, 2020)')
ax.annotate('Source: PhilGIS and data compiled from daily reports of 100% Pusong Malabon Facebook Page (accessed June 8, 2020).', xy=(0.10,0.05), xycoords='figure fraction', horizontalalignment='left', verticalalignment='top', fontsize=8, color='#555555')
